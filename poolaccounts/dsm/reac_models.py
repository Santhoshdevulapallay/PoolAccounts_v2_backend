...
# SRAS related models
class REACBaseModel(models.Model):
...
class REACPayments(models.Model):
      ...
      paystatus_fk=models.ForeignKey(REACBaseModel,on_delete=models.SET_NULL,null=True)
...
class REACReceivables(models.Model):
      Disbursed_amount=models.FloatField(blank=True,null=True)
      rcvstatus_fk=models.ForeignKey(REACBaseModel,on_delete=models.SET_NULL,null=True)
