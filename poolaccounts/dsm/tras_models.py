...
# SRAS related models
class TRASBaseModel(models.Model):
...
class TRASPayments(models.Model):
      ...
      paystatus_fk=models.ForeignKey(TRASBaseModel,on_delete=models.SET_NULL,null=True)
...
class TRASReceivables(models.Model):
      Disbursed_amount=models.FloatField(blank=True,null=True)
      rcvstatus_fk=models.ForeignKey(TRASBaseModel,on_delete=models.SET_NULL,null=True)
