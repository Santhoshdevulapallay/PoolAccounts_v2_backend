...
class NetASBaseModel(models.Model):
      ...
      SRAS_id=models.TextField(default=None,blank=True,null=True)  #id refres to SRASBaseModel id same as for TRAS MBAS and SCUC
      TRAS_id=models.TextField(default=None,blank=True,null=True)
      MBAS_id=models.TextField(default=None,blank=True,null=True)
      SCUC_id=models.TextField(default=None,blank=True,null=True)
...
class NetASPayments(models.Model):
      ...
      paystatus_fk=models.ForeignKey(NetASBaseModel,on_delete=models.SET_NULL,null=True)
      ...
      class Meta:
            db_table = 'netas_payments'
            unique_together=['Paid_date','Description','Paid_amount','paystatus_fk']

class NetASReceivables(models.Model):
      Disbursed_amount=models.FloatField(blank=True,null=True)
      rcvstatus_fk=models.ForeignKey(NetASBaseModel,on_delete=models.SET_NULL,null=True)
