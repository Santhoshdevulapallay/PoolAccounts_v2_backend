...
# CONG related models
class CONGBaseModel(models.Model):
...
class CONGPayments(models.Model):
      ...
      paystatus_fk=models.ForeignKey(CONGBaseModel,on_delete=models.SET_NULL,null=True)
...
class CONGReceivables(models.Model):
      Disbursed_amount=models.FloatField(blank=True,null=True)
      rcvstatus_fk=models.ForeignKey(CONGBaseModel,on_delete=models.SET_NULL,null=True)
